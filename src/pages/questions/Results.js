...
function Result({ answers, iframeUrl, risk, suggestion }) {
    return (
        <>
            ...
            {/* Sample Output */}
            {!iframeUrl && <div style={{ fontSize: '20px', textAlign: 'center', paddingTop: '16px' }}>This is a sample output. Please connect to the Python model to see the actual results. In order to connect to the Python model, please clone the repo from github and do npm start.</div>}
            ...
            {!iframeUrl && (
                <div style={{ color: "#ffffff", marginTop: '16px', padding: '8px 16px' }}>
                    <iframe
                        src={"http://localhost:8000/static/22229b92b1b04136ab4cfd301b1efdd9.html"}
